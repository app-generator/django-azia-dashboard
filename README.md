# [Django Dashboard](https://appseed.us/admin-dashboards/django?ref=gh) Azia

[Admin dashboard](https://appseed.us/admin-dashboards) generated by AppSeed in **Django** Framework.

**[Azia Dashboard](https://appseed.us/admin-dashboards/django-dashboard-azia)** is a beautifully designed admin template featuring a fine selection of useful Bootstrap components and elements. The pre-built pages of the templates are intuitive and very well-designed.
The pre-built pages of the templates are intuitive and very well-designed. **Azia Dashboard** is sure to make your development process truly enjoyable.
...
---
[Django Dashboard](https://appseed.us/admin-dashboards/django?ref=gh) Azia - Provided by **AppSeed [App Generator](https://appseed.us/app-generator)**.
